...
Retrouve ici les cours, les fiches de révision et les quiz préparés à partir des documents de classe.

## Physique-chimie

### Chapitre 17 · Couleurs, trichromie et synthèses

Comprendre comment les lumières se mélangent, comment l'œil perçoit les couleurs et pourquoi la couleur d'un objet dépend de son éclairage.

[Lire le cours](physique-chimie/chapitre-17-couleurs.md){ .md-button .md-button--primary }
